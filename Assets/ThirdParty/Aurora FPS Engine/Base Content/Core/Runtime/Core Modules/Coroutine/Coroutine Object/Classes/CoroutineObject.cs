...
namespace AuroraFPSRuntime.CoreModules.Coroutines
{
    ...
    public sealed class CoroutineObject<T1, T2, T3> : CoroutineObjectBase
    {
        ...
        #region [Getter / Setter]
        public Func<T1, T2, T3, IEnumerator> GetRoutine()
        {
            return routine;
        }

        private void SetRoutine(Func<T1, T2, T3, IEnumerator> value)
        {
            routine = value;
        }
        #endregion
    ...
    public sealed class CoroutineObject<T1, T2, T3, T4> : CoroutineObjectBase
    {
        ...
        #region [Getter / Setter]
        public Func<T1, T2, T3, T4, IEnumerator> GetRoutine()
        {
            return routine;
        }

        private void SetRoutine(Func<T1, T2, T3, T4, IEnumerator> value)
        {
            routine = value;
        }
        #endregion
