...
namespace AuroraFPSRuntime.CoreModules.Serialization.Collections
{
    ...
    public class SerializableHashSet<T> : SerializableHashSetBase, ICollection<T>, IEnumerable<T>, IEnumerable, IReadOnlyCollection<T>, ISet<T>, IDeserializationCallback, ISerializable
    {
        ...
        {
            return ((ICollection<T>)hashSet).GetEnumerator();
        }
