...
namespace AuroraFPSRuntime.CoreModules.Serialization.Collections
{
    ...
    public class SerializableStack<T> : SerializableStackBase, IEnumerable<T>, IEnumerable, IReadOnlyCollection<T>, ICollection
    {
        // Stack reference.
        protected Stack<T> stack;

        // Serialized Stack reference values.
