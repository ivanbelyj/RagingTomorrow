...
namespace AuroraFPSRuntime.CoreModules.Serialization.Collections
{
    ...
    public class SerializableLinkedList<T> : SerializableLinkedListBase, IEnumerable<T>, IEnumerable, IReadOnlyCollection<T>, ICollection, IDeserializationCallback, ISerializable
    {
        // LinkedList reference.
        protected LinkedList<T> linkedList;

        // Serialized LinkedList reference values.
        ...
        public override void OnAfterDeserialize()
        {
            if (values != null)
            {
                linkedList = new LinkedList<T>(values);
                values = null;
            }
        }
        ...
        public SerializableLinkedList(IEnumerable<T> collection)
        {
        ...
        {
            return linkedList.AddAfter(node, value);
        }
        ...
        {
            return linkedList.AddBefore(node,value);
        }
        ...
        {
            linkedList.OnDeserialization(sender);
        }
        #endregion
        ...
        {
            linkedList.GetObjectData(info, context);
        }
        #endregion
    }
}